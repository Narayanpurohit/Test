...
async def handle_video(client, update: Message):
    # Get the video file
    await update.reply_text("📥 Downloading your video...")
    video = await update.download()
    await progress_update.edit_text("📤 adding watermark to your video...")
    ...
    await progress_update.edit_text("📤 Uploading your watermarked video...")
