...
def add_watermark(video_path, output_path, text="Watermark", position=None,
                  movement="moving", speed=2, direction="horizontal", loop=True,
                  border_thickness=2, border_color=(0, 0, 255), text_color=(255, 255, 255),
    ...
    while True:
        ...
        # Add watermark with customizable border and text colors
        if border_thickness > 0:
            cv2.putText(frame, text, (x, y), font, font_scale, border_color, border_thickness, cv2.LINE_AA)
